...
import { Plus, Sparkles, LogOut, Globe, BookOpen, Loader2, PawPrint } from 'lucide-react';
...
export function AdminDashboard({ onSelectWorld, onManagePets, onLogout }: AdminDashboardProps) {
