...
import { Plus, Sparkles, Globe, BookOpen, Loader2 } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400">Manage story worlds and adventures</p>
            </div>
...
function CreateWorldModal({ onClose, onCreated }: { onClose: () => void; onCreated: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-6 z-50">
      ...
      >
        <h2 className="text-xl font-bold mb-4 text-white">Create World</h2>
